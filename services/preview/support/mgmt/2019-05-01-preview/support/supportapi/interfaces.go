...
type BaseClientAPI interface {
	AddCommunicationToSubscriptionTicket(ctx context.Context, supportTicketName string, addCommunication support.AddCommunication) (result support.CommunicationDetails, err error)
	...
	CreateSupportTicketForSubscription(ctx context.Context, supportTicketName string, createSupportTicketParameters support.CreateSupportTicket) (result support.CreateSupportTicketForSubscriptionFuture, err error)
}
