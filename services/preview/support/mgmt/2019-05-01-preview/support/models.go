...
// AddCommunication communication details.
type AddCommunication struct {
	// Sender - Sender of the message. Defaulted to the UPN of the logged in user is this is not provided.
	Sender *string `json:"sender,omitempty"`
	// Subject - Subject in plain text
	Subject *string `json:"subject,omitempty"`
	// Body - Body in plain text
...
type CheckNameAvailabilityInput struct {
	...
	// Type - The type of resource, Microsoft.Support/supportTickets
...
type CommunicationDetailsProperties struct {
	// CommunicationType - Communication type. Possible values include: 'Web', 'Phone'
	CommunicationType CommunicationType `json:"communicationType,omitempty"`
	// CommunicationDirection - Direction of communication. Possible values include: 'Inbound', 'Outbound'
	...
	Body *string `json:"body,omitempty"`
	// CreatedDate - Time in UTC (ISO 8601 format) when the communication was created.
...
// CreateSupportTicket describes the payload for creating a support ticket. Customers can create tickets
// for issues relating to Billing, Subscription Management, Service and subscription limits(quotas) and
// Technical as determined by service id in the request payload.
type CreateSupportTicket struct {
	...
	Type *string `json:"type,omitempty"`
	// CreateSupportTicketProperties - Properties of support ticket.
	*CreateSupportTicketProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for CreateSupportTicket.
func (cst CreateSupportTicket) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cst.CreateSupportTicketProperties != nil {
		objectMap["properties"] = cst.CreateSupportTicketProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for CreateSupportTicket struct.
func (cst *CreateSupportTicket) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var createSupportTicketProperties CreateSupportTicketProperties
				err = json.Unmarshal(*v, &createSupportTicketProperties)
				if err != nil {
					return err
				}
				cst.CreateSupportTicketProperties = &createSupportTicketProperties
			}
		}
	}
...
// CreateSupportTicketProperties describes the payload for creating a support ticket. Customers can create
// tickets for issues relating to Billing, Subscription Management, Service and subscription limits(quotas)
// and Technical as determined by service id in the request payload.
type CreateSupportTicketProperties struct {
	// ServiceID - Azure service for which the support ticket will be created.
	...
	// ProblemClassificationID - Problem classification id associated with the support ticket. This indicates the problem or the issue that the ticket is being opened for.
	ProblemClassificationID *string `json:"problemClassificationId,omitempty"`
	// Severity - The severity associated with the support ticket. Possible values include: 'Minimal', 'Moderate', 'Critical'
	Severity SeverityLevel `json:"severity,omitempty"`
	// Require24X7Response - Indicates if a 24x7 response is requested by the support ticket creator.
	Require24X7Response *bool `json:"require24X7Response,omitempty"`
	// ContactDetails - User contact details associated with the support ticket.
...
type Engineer struct {
	// EmailAddress - Support engineer email address.
...
// ProblemClassificationDetails the details of the problem classification for which this support ticket was
// created.
type ProblemClassificationDetails struct {
...
// ServiceDetails the details of the Azure service for which this support ticket was created.
...
type ServiceLevelAgreement struct {
	// StartTime - Time in UTC (ISO 8601 format) when SLA started.
	StartTime *date.Time `json:"startTime,omitempty"`
	// ExpirationTime - Time in UTC (ISO 8601 format) when SLA expires.
	ExpirationTime *date.Time `json:"expirationTime,omitempty"`
	// SLAMinutes - Service Level Agreement in minutes
...
type TicketDetailsProperties struct {
	// SupportTicketID - System generated support ticket id.
	SupportTicketID *string `json:"supportTicketId,omitempty"`
	// Description - Description of the support ticket.
	Description *string `json:"description,omitempty"`
	// ProblemClassificationDetails - This is the issue or the problem details that the support ticket is opened for.
	ProblemClassificationDetails *ProblemClassificationDetails `json:"problemClassificationDetails,omitempty"`
	// Severity - Severity of the support ticket. Possible values include: 'Minimal', 'Moderate', 'Critical'
	Severity SeverityLevel `json:"severity,omitempty"`
	// EnrollmentID - Enrollment ID associated with the support ticket.
	EnrollmentID *string `json:"enrollmentId,omitempty"`
	// ProductionOutage - Indicates if this is a production outage.
	ProductionOutage *bool `json:"productionOutage,omitempty"`
	// Is24X7Response - Indicates if this is a 24x7 support ticket.
	Is24X7Response *bool `json:"is24X7Response,omitempty"`
	...
	// SupportPlanType - Support plan type associated with the support ticket.
	SupportPlanType *string `json:"supportPlanType,omitempty"`
	// Title - Title of the support ticket.
	Title *string `json:"title,omitempty"`
	// ServiceDetails - This is the Azure service details for which the support ticket was opened.
	ServiceDetails *ServiceDetails `json:"serviceDetails,omitempty"`
	// Status - Status of the support ticket.
	Status *string `json:"status,omitempty"`
	// CreatedDate - Time in UTC (ISO 8601 format) when support ticket was created.
	CreatedDate *date.Time `json:"createdDate,omitempty"`
	// ModifiedDate - Time in UTC (ISO 8601 format) when support ticket was last modified.
