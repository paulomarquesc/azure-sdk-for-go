...
// AddCommunicationToSubscriptionTicket adds a communication to a support ticket.
// Parameters:
// supportTicketName - support ticket id.
// addCommunication - communication object.
func (client BaseClient) AddCommunicationToSubscriptionTicket(ctx context.Context, supportTicketName string, addCommunication AddCommunication) (result CommunicationDetails, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/BaseClient.AddCommunicationToSubscriptionTicket")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: addCommunication,
			Constraints: []validation.Constraint{{Target: "addCommunication.Subject", Name: validation.Null, Rule: true, Chain: nil},
				{Target: "addCommunication.Body", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("support.BaseClient", "AddCommunicationToSubscriptionTicket", err.Error())
	}

	req, err := client.AddCommunicationToSubscriptionTicketPreparer(ctx, supportTicketName, addCommunication)
	if err != nil {
		err = autorest.NewErrorWithError(err, "support.BaseClient", "AddCommunicationToSubscriptionTicket", nil, "Failure preparing request")
		return
	}

	resp, err := client.AddCommunicationToSubscriptionTicketSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "support.BaseClient", "AddCommunicationToSubscriptionTicket", resp, "Failure sending request")
		return
	}

	result, err = client.AddCommunicationToSubscriptionTicketResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "support.BaseClient", "AddCommunicationToSubscriptionTicket", resp, "Failure responding to request")
	}

	return
}

// AddCommunicationToSubscriptionTicketPreparer prepares the AddCommunicationToSubscriptionTicket request.
func (client BaseClient) AddCommunicationToSubscriptionTicketPreparer(ctx context.Context, supportTicketName string, addCommunication AddCommunication) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.Support/supportTickets/{supportTicketName}/addCommunication", pathParameters),
		autorest.WithJSON(addCommunication),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// AddCommunicationToSubscriptionTicketSender sends the AddCommunicationToSubscriptionTicket request. The method will close the
// http.Response Body if it receives an error.
func (client BaseClient) AddCommunicationToSubscriptionTicketSender(req *http.Request) (*http.Response, error) {
	sd := autorest.GetSendDecorators(req.Context(), azure.DoRetryWithRegistration(client.Client))
	return autorest.SendWithSender(client, req, sd...)
}

// AddCommunicationToSubscriptionTicketResponder handles the response to the AddCommunicationToSubscriptionTicket request. The method always
// closes the http.Response Body.
func (client BaseClient) AddCommunicationToSubscriptionTicketResponder(resp *http.Response) (result CommunicationDetails, err error) {
...
func (client BaseClient) CreateSupportTicketForSubscription(ctx context.Context, supportTicketName string, createSupportTicketParameters CreateSupportTicket) (result CreateSupportTicketForSubscriptionFuture, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: createSupportTicketParameters,
			Constraints: []validation.Constraint{{Target: "createSupportTicketParameters.CreateSupportTicketProperties", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ServiceID", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "createSupportTicketParameters.CreateSupportTicketProperties.Title", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "createSupportTicketParameters.CreateSupportTicketProperties.Description", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ProblemClassificationID", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ContactDetails", Name: validation.Null, Rule: true,
						Chain: []validation.Constraint{{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ContactDetails.FirstName", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ContactDetails.LastName", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ContactDetails.PrimaryEmailAddress", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ContactDetails.PreferredTimeZone", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ContactDetails.Country", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "createSupportTicketParameters.CreateSupportTicketProperties.ContactDetails.PreferredSupportLanguage", Name: validation.Null, Rule: true, Chain: nil},
						}},
				}}}}}); err != nil {
...
func (client BaseClient) CreateSupportTicketForSubscriptionPreparer(ctx context.Context, supportTicketName string, createSupportTicketParameters CreateSupportTicket) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"supportTicketName": autorest.Encode("path", supportTicketName),
	}
